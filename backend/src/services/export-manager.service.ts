...
export class ExportManagerService {
  ...
  static generateExcel(report: AnalysisReport): Buffer {
    ...
    const issuesData: { Type: string; Target: string; Description: string }[] = [];
   ...
   */
  static generateCsv(transactions: WebhookTransaction[]): string {
    const headers = [
      'Webhook ID',
      'Event Type',
      'Patient ID',
   ...
   */
  static generateHtmlReport(report: AnalysisReport): string {
