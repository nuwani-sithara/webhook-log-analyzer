...
export function generateMockLogs(numLines) {
    const logs = [];
...
export function generatePdf(numPages, outputPath) {
...
const isDirectRun = process.argv[1] && (process.argv[1].endsWith('test-generator.ts') ||
